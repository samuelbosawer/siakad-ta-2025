                    ...
                    <div class="table-responsive text-nowrap p-3">
                        <div class="row">
                            <div class="col-6 my-3">
                                <a class="btn btn-primary" href="{{ route('dashboard.form-magang.tambah') }}">Tambah Data
                                    Magang Mahasiwa <i class="bx bx-plus me-1"></i></a>
                            </div>
                            <div class="col-6 my-3">
                            ...
                            @forelse ($datas as $data)
                                <tr>
                                    ...
                                    <td class="fw-bolder"> <a
                                            href="{{ route('dashboard.form-magang.ubah', $data->id) }}">{{ $data->magang->nama_magang }}</a>
                                    </td>
                                    <td>{{ $data->mahasiswa->nama_depan ?? ('' . ' ' . $data->mahasiswa->nama_belakang ?? '') }}
                                    </td>
                                    <td> {{ $data->status ?? '-' }}</td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="{{ route('dashboard.form-magang.detail', $data->id) }}">
                                                    <i class="bx bx-box me-1"></i> Detail</a>

                                               @if(!Auth::user()->hasAnyRole(['mahasiswa', 'dosen']))
                                                    <a class="dropdown-item"
                                                        href="{{ route('dashboard.form-magang.ubah', $data->id) }}"><i
