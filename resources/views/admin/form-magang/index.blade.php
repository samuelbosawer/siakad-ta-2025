...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="row ">
    <div class="col-12">
        ...
        <div class="card">
                <h5 class="card-header">Data  Magang Mahaisiwa</h5>
                <div class="table-responsive text-nowrap p-3">
                  <div class="row">
                    <div class="col-6 my-3">
                      <a class="btn btn-primary" href="{{ route('dashboard.form-magang.tambah') }}">Tambah Data Magang Mahasiwa <i class="bx bx-plus me-1"></i></a>
                    </div>
                    <div class="col-6 my-3">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody class="table-border-bottom-0">
                      ...
                      <tr>
                        <td>{{ ++$i }}</td>
                        <td class="fw-bolder"> <a href="{{ route('dashboard.form-magang.ubah', $data->id) }}">{{ $data->magang->nama_magang }}</a></td>
                        ...
                        <td class="text-center">
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="{{ route('dashboard.form-magang.detail', $data->id) }}"
                                >
                                <i class="bx bx-box me-1"></i> Detail</a
                              >
                              <a class="dropdown-item" href="{{ route('dashboard.form-magang.ubah', $data->id )}}"><i class="bx bx-edit-alt me-1"></i> Ubah</a
                              >

                            <form action="{{ route('dashboard.form-magang.hapus', $data->id) }}" 
                                    method="POST" 
