                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            @if (Request::segment(4) == 'ubah' && Request::segment(2) == 'form-kkn')
                                <form action="{{ route('dashboard.form-kkn.update', $data->id) }}" enctype="multipart/form-data"
                                    method="POST">
                                    @csrf
                                    @method('PUT')
                        ...
                        <div class="col-md-6 mb-3">
                         ...
                         <div class="col-md-6 mb-3">
                            ...
                            <select name="kkn_id" class="form-select"  @if (Request::segment(3) == 'detail') disabled @endif>
                                <option value="">Pilih KKN</option>
                                @foreach ($kkns as $k)
                                    <option value="{{ $k->id }}"
                                        @selected( old('kkn_id', $data->kkn_id ?? '') == $k->id )>
                                        {{ $k->nama_kkn }}
                                    </option>
                                @endforeach
                            </select>
                            @error('kkn_id') <small class="text-danger">{{ $message }}</small> @enderror
                        </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <p>
                                        ...
                                        <a href="{{ asset('storage/' . $data->kem_studi) }}" target="_blank" class="btn btn-dark btn-sm">Lihat File</a>
                                        @endif
                                    </p>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <p>
                                        ...
                                        <a href="{{ asset('storage/' . $data->bukti_bayar) }}" target="_blank" class="btn btn-dark btn-sm">Lihat File</a>
                                        @endif
                                    </p>
                            ...
                            <div class="col-md-12 mb-3 mx-auto">
                                @if (Request::segment(3) == 'detail')
                                    <a href="{{ route('dashboard.form-kkn.ubah', $data->id) }}" class="btn btn-dark text-white">
